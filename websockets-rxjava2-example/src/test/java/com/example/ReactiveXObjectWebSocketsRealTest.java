...
public class ReactiveXObjectWebSocketsRealTest {

    private ReactiveXObjectWebSockets socket;
    ...
    public void setUp() throws Exception {
        ...
        final ReactiveXWebSockets rxWebSockets = new ReactiveXWebSockets(new OkHttpClient(),
                new Request.Builder()
                        .get()
                        .url("ws://10.10.0.2:8080/ws")
                        .addHeader("Sec-WebSocket-Protocol", "chat")
                        .build());
        socket = new ReactiveXObjectWebSockets(rxWebSockets, new GsonObjectSerializer(gson, Message.class));
    }
